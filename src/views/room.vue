<template>
  <el-container class="container">
    ...
    <el-footer class="footer" height="160px">
      ...
      <el-button @click="acceptVoice">接收视频</el-button>
      <el-button @click="closeVoice">关闭视频</el-button>
...
<script>
  ...
  import WebIM from '@/config/WebIM.js'
  ...
  export default {
    ...
    methods: {
      ...
      // 发视频
      sendVideo() {
        WebIM.call.caller = this.username
        WebIM.call.makeVideoCall(this.chatId)
      },
      // 发语音
      sendVoice() {
        WebIM.call.caller = this.username
        WebIM.call.makeVoiceCall(this.chatId)
      },
      acceptVoice() {
